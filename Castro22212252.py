...
hipoPI = controlador(28.5036882709054,2842.53829989085,syshipo)
hiperPI = controlador (425.829690306291,25392.7781961145,syshiper)
...
fg2 = plt.figure()
plt.plot(t,Pp0,'-',linewidth = 1, color = clr1,label = 'Pp(t):Normotenso')
plt.plot(t,Pp3,'--',linewidth = 3, color = clr2,label = 'Pp(t):Hipotenso PI')
plt.plot(t,Pp2,'-',linewidth = 1, color = clr6,label = 'Pp(t):Hipertenso')
plt.grid(False)
